import { getChangeStreamForDb } from "../../lib/mongodb";
...
export default async (req, res) => {
  ...
  if (accept === "text/event-stream") {
    ...
    const { sessionId, colName, _id } = req.query;
    ...
    const databaseName = (industry === "manufacturing" ? manufacturing : retail)
      .mongodbDatabaseName;
    const changeStream = await getChangeStreamForDb(filter, key, databaseName);
